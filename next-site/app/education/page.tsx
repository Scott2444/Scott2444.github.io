        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-4">
          <div>
            <div className="flex items-center">
              <h3 className="text-xl font-semibold text-gray-800">{activity.Club}</h3>
            </div>
            {activity.Position && (
...
function SchoolCard({ school, index }: { school: School, index: number }) {
  ...
  return (
    ...
    >
      {/* Timeline connector */}
      {index > 0 && (
        <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 h-8 w-0.5 bg-gray-300"></div>
      )}
      
      {/* Year indicator */}
      <div className="flex justify-center mb-6">
        <div className="bg-gray-100 text-gray-700 px-6 py-2 rounded-full font-medium shadow-sm">
      ...
      {/* School card */}
      <div 
        className="bg-white shadow-lg rounded-lg overflow-hidden border border-gray-200 hover:shadow-xl transition-all duration-300 border-t-8" 
        style={{ borderTopColor: school.Color || '#374151' }}
      >
        {/* Banner Image */}
        {school.Banner && (
        ...
        {!school.Banner && (
          <div className="py-6 px-8 bg-gradient-to-r" style={{ backgroundImage: `linear-gradient(to right, ${school.Color || '#374151'}, ${adjustColorBrightness(school.Color || '#374151', 30)})` }}>
        ...
        <div className="p-6">
          {activeTab === 'academics' && (
            <div className="space-y-6">
              ...
              <div className="flex flex-col md:flex-row md:items-start md:justify-between">
                <div>
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-gray-700">GPA: {school.GPA.toFixed(2)}/4.00</p>
                  </div>
                </div>
              ...
              {school["Selected Courses"] && school["Selected Courses"].length > 0 && (
                <div>
                  <h4 className="text-lg font-medium text-gray-800 mb-4">Selected Courses</h4>
          ...
          {activeTab === 'activities' && (
            <div>
              <h4 className="text-lg font-medium text-gray-800 mb-4">Extracurricular Activities</h4>
